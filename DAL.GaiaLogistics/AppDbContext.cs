...
using Domain.GaiaLogistics;
using Domain.GaiaLogistics.Contracts;

namespace DAL.GaiaLogistics
{
    public sealed class AppDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder options)
        {
            ...
            {
                options.UseSqlServer("Data Source=localhost;Initial Catalog=DbGaiaLogistics;User ID=sa;Password=BxCLM8xter343.n;Encrypt=False;");
            }
        }
